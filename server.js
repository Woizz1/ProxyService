...
const onProxyReq = (proxyReq, req, res, options) => {
  ...
  proxyReq.setHeader("Authorization", "Bearer AAAAAAAAAAAAAAAAAAAAAKiUYAEAAAAA3B6ivXOWnZbKKYwndH%2Bkauh5ycY%3DbxFEJgRWujKoD6yhDUBo9HSV40tQFI8xSIyrTSkY2wVtoSTq6x")
